...
Unicode character [#norm:unicode_char]#MNO ≥ PQR# outside.

:ge: &#8805;

Macro call [#norm:macro_call]#200 {ge} 100# outside.

Attribute in formatting [#norm:attribute_in_formatting]#*{ge}* and _{ge}_# outside.

Attribute with hyperlink [#norm:attribute_with_hyperlink]#It isn't 100, it's {ge} <<norm:superscript>># outside.

Undefined attribute [#norm:attribute_undefined]#200 {no-such-attribute} 100# outside.
...
=== Chapter 1.5 - Tagging Unordered Lists
...
=== Chapter 1.6 - Tagging Ordered Lists
...
=== Chapter 1.7 - Tagging Description Lists
...
== Chapter 2 - Implementation-Defined Behaviors
...
[[norm:hword]]
This is a half-word (16 bits).

[[norm:word]]
This is a word (32 bits).

[[norm:dword]]
This is a double-word (64 bits).

[[norm:boolean-context]]
Here's some context for the boolean.

[[norm:uint6]]
This is a 6-bit unsigned integer.
...
[[norm:int2]]
This is a 2-bit signed integer.

[[norm:uint-1to100]]
This is an unsigned integer in the range of 1 to 100.

[[norm:uint-4to8]]
This is an unsigned integer in the range of 4 to 8.
...
[[norm:list-int]]
This is a list with values 1, 2 and 4.

[[norm:foobar-ch1]]
This is the Ch1 part of the foobar normative rule.

[[norm:array]]
Can have up to 29 performance counters. Reading an unimplemented performance counter either
returns a value or raises an illegal instruction exception, depending on the implementation.
